				...
				<div class="card">
					<div class="card-body">
                        ...
                        <?php foreach($list_mhs as $row) { ?>
												<option value="<?= $row->nim ?>" <?= $pembayaran[0]->nim == $row->nim ? 'selected' : null ?>><?= $row->nama_mahasiswa ?></option>
                        <?php } ?> 
                      </select> 
                      <input type="hidden" name="kode_pembayaran" value="<?= $pembayaran[0]->kode_pembayaran ?>">
										</div>
									</div>
                  <div class="form-group row">
										<label class="col-lg-2 col-form-label" for="mhs">No KPS</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" value="<?= $pembayaran[0]->no_kps ?>" name="no_kps" readonly>
										</div>
									</div>
                  <div class="form-group row">
										...
										<div class="col-lg-10">
											<select name="tahun_akademik" id="tahun" class="form-control">
												...
												?>
														<option value="<?php echo $x ?>" <?= $pembayaran[0]->tahun_akademik == $x ? 'selected' : null ?>><?php echo $x ?></option>
												<?php
												}
												?>
											</select>
                  ...
                  <div class="form-group row">
										...
										<div class="col-lg-10">
											<select name="semester" id="semester" class="form-control">
												<option value="1" <?= $pembayaran[0]->semester == 1 ? 'selected' : null ?>>I Ganjil</option>
												<option value="2" <?= $pembayaran[0]->semester == 2 ? 'selected' : null ?>>II Genap</option>
												<option value="3" <?= $pembayaran[0]->semester == 3 ? 'selected' : null ?>>III Ganjil</option>
												<option value="4" <?= $pembayaran[0]->semester == 4 ? 'selected' : null ?>>VI Genap</option>
												<option value="5" <?= $pembayaran[0]->semester == 5 ? 'selected' : null ?>>X Ganjil</option>
												<option value="6" <?= $pembayaran[0]->semester == 6 ? 'selected' : null ?>>IV Genap</option>
											</select>
										</div>
									</div>
                  <div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="date" value="<?= $pembayaran[0]->tanggal ?>" class="form-control" name="tanggal">
										</div>
									</div>
                  ...
                  <div class="form-group row" id="form1">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_1" value="<?= $pembayaran[0]->sumbangan_pendidikan ?>" class="form-control" name="sumbangan_pendidikan" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
                  ...
                  <div class="form-group row" id="form2">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_2" value="<?= $pembayaran[0]->biaya_kuliah_semester ?>" class="form-control" name="biaya_kuliah_semester" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
                  ...
                  <div class="form-group row" id="form3">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_3" value="<?= $pembayaran[0]->biaya_seragam_perlengkapan ?>" class="form-control" name="biaya_seragam_perlengkapan" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form4">
										<label class="col-lg-4 col-form-label">Biaya pengenalan akademik</label>
										<div class="col-lg-6">
											<input type="number" id="biaya_4" value="<?= $pembayaran[0]->biaya_pengenalan_akademik ?>" class="form-control" name="biaya_pengenalan_akademik" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form5">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_5" value="<?= $pembayaran[0]->biaya_capping_day ?>" class="form-control" name="biaya_capping_day" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form6">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_6" value="<?= $pembayaran[0]->biaya_kkn ?>" class="form-control" name="biaya_kkn" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form7">
										<label class="col-lg-4 col-form-label">Biaya ujian akhir semester</label>
										<div class="col-lg-6">
											<input type="number" id="biaya_7" value="<?= $pembayaran[0]->biaya_ujian_akhir ?>" class="form-control" name="biaya_ujian_akhir" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form8">
										<label class="col-lg-4 col-form-label" for="mhs">Biaya wisuda</label>
										<div class="col-lg-6">
											<input type="number" id="biaya_8" value="<?= $pembayaran[0]->biaya_wisuda ?>" class="form-control" name="biaya_wisuda" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form9">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_9" value="<?= $pembayaran[0]->biaya_IKM ?>" class="form-control" name="biaya_IKM" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form10">
										<label class="col-lg-4 col-form-label">Biaya formulir</label>
										<div class="col-lg-6">
											<input type="number" id="biaya_10" value="<?= $pembayaran[0]->biaya_formulir ?>" class="form-control" name="biaya_formulir">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form11">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_11" value="<?= $pembayaran[0]->biaya_test_kesehatan ?>" class="form-control" name="biaya_test_kesehatan" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row" id="form12">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_12" value="<?= $pembayaran[0]->biaya_lain ?>" class="form-control" name="biaya_lain" onkeyup="hitung()">
										</div>
                    <div class="col-lg-2">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="number" id="biaya_total" value="<?= $pembayaran[0]->jumlah_disetor ?>" class="form-control" name="jumlah_disetor" onkeyup="hitung()" readonly>
										</div>
									</div>
