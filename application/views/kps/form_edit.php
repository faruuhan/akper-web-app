					...
					<div class="card-body">
							...
							<div class="row">
								<div class="col">
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" value="<?= $list_kps[0]->no_kps ?>" name="no_kps"
												id="nokps" readonly>
                        <input type="hidden" class="form-control" value="<?= $this->uri->segment(2) ?>" name="page"
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" value="<?= $list_kps[0]->semester ?>" name="semester" id="semester" readonly>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-2 col-form-label" for="tahun">Tahun Akademik</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" value="<?= $list_kps[0]->tahun_akademik ?>" name="tahun_akademik" id="tahun" readonly>
										</div>
									</div>
